...
https://github.com/kylvng/SysProg-Class

4. Briefly describe what you want to get out of this class.
I want to learn to develop software to connect the low-level computer hardware to high-level, user-facing application software.

5. Briefly describe any concerns you might be having with being successful in this class (if any).
Keeping up with the class. Fast pace class.